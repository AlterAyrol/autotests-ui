...
class NavbarComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.app_title = Text(page, 'navigation-navbar-app-title-text', "App name")
        self.welcome_title = Text(page, 'navigation-navbar-welcome-title-text', "Welcome user title")
